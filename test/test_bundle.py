...
@pytest.mark.signing
@pytest.mark.xfail(reason="Client support for DSSE pending")
def test_sign_bundle_with_dsse(
    client: SigstoreClient,
    make_materials_by_type: _MakeMaterialsByType,
) -> None:
    """
    ...
    """
    materials: BundleMaterials
    input_path, materials = make_materials_by_type("assets/statement.json", BundleMaterials)
    assert not materials.exists()
